...
add_action( 'acf/init', function () {
	...
	acf_add_local_field_group( array(
		...
		'fields'   => array(
			...
			ll_ta( 'f_ll_hero_stats', 'll_hero_stats', 'Numeri chiave', "~1h15 | tempo di stampa\n~50 g | peso pezzo\n€3,30 | al pezzo", 6, 'Una riga per numero, formato: VALORE | ETICHETTA' . '  (es. ~1h15 | tempo di stampa)' ),
			ll_f( 'f_ll_hero_tags', 'll_hero_tags', 'Etichette sotto il sottotitolo', 'text', '', array( 'instructions' => 'I tag del whitepaper, separati da virgola. Vuoto = nessuna etichetta.' ) ),
